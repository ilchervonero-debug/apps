const CACHE = 'ilcalc-v11';
const ASSETS = [
  '/apps/ilcalc/',
  '/apps/ilcalc/index.html',
  '/apps/ilcalc/manifest.json',
  '/apps/ilcalc/icon-192.svg'
];
...
self.addEventListener('fetch', e => {
  ...
  if (url.includes('googleapis.com') || url.includes('gstatic.com/firebasejs') || url.includes('firebaseio.com') || url.includes('supabase.co') || url.includes('er-api.com')) return;
  const req = e.request;
