...
// Muros, Techos y Cielorrasos en realidad suman varias tareas reales
// (estructura + terminación); acá se linkea la principal como punto de
// partida, 100% editable en Vincular. Cerchas y Columnas reticuladas
// quedan sin vínculo: se costean por pieza (cortes + conexiones), no por
// tarea — ver GRUPOS_RETICULADOS en engine/costo.js.
export const SEED_RENDIMIENTOS = {
  ...
  cielos: 'Armado Estructura Suspendida/Directa (cielorraso)',
}
